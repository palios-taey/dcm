...
There is no 3- or 4-seat "council": the production floor is 8–12 seats by blast radius with defined
...
# smaller tier: a 3- or 4-seat "council" is not a council. With the producer + a synthesizer/clerk this is a 10–12-seat
...
# Any one of these being true escalates to the full high-blast-radius council.
